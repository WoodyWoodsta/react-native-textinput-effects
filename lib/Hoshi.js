...
export default class Hoshi extends BaseInput {
  ...
  render() {
    ...
    const flatLabelStyles = StyleSheet.flatten(labelStyle) || {};
    const labelFontSize = flatLabelStyles.fontSize || styles.label.fontSize;
          ...
          <Animated.View
            style={[
              ...
              activeUnderlineStyle,
              {
                ...
                bottom: -flatStyles.borderBottomWidth,
              },
            ]}
          />
        </View>
